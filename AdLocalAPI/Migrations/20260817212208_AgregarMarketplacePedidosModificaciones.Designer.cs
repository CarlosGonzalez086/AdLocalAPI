...
namespace AdLocalAPI.Migrations
{
    ...
    [Migration("20260817212208_AgregarMarketplacePedidosModificaciones")]
    partial class AgregarMarketplacePedidosModificaciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdLocalAPI.Models.Pedido", b =>
                {
                    ...
                    b.Property<string>("ReferenciasEntrega")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("TelefonoRecibe")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("AdLocalAPI.Models.CarritoDetalle", b =>
                {
                    b.HasOne("AdLocalAPI.Models.Carrito", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AdLocalAPI.Models.DireccionUsuario", b =>
                {
                    b.HasOne("AdLocalAPI.Models.Estado", null)
                        .WithMany()
                        .HasForeignKey("IdEstado")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdLocalAPI.Models.Municipio", null)
                        .WithMany()
