...
<head>
  <meta charset='UTF-8' />
  <meta name='viewport' content='width=device-width, initial-scale=1.0'/>
  <title>Bienvenido a AdLocal</title>
</head>
        ...
        '>
          ...
          <tr>
            <td align='center' style='padding-bottom: 24px;'>
              ...
              '>
                ...
                Tu cuenta como colaborador ya fue creada.<br/>
                Para comenzar, confirma tu acceso creando tu contraseña 🚀
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td align='center' style='padding: 26px 0;'>
              <a href='{linkCrearPassword}' style='
                background-color: #6F4E37;
                color: #ffffff;
                text-decoration: none;
                padding: 14px 36px;
          ...
          <tr>
            <td align='center' style='padding-top: 12px;'>
              <p style='
                ...
                margin: 0;
              '>
                Este código y enlace son personales y pueden expirar.<br/>
                Si no reconoces este acceso, ignora este correo.
              </p>
            </td>
          </tr>
